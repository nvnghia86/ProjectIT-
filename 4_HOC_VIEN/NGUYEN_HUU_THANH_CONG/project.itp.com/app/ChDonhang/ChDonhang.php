<?php
/**
 * App quản lý danh mục Don Hang
 * Create: 08-10-2017
 * @author Longnv <minhlongyb.89@gmai.com>
 * @version 1.0
 */
session_start();
ob_start();
...
?>
<?php
class ChDonhangApp extends AppObject {
    public $app_name="ChDonhang";
    public $dir_layout="cahd_skin"; 
    public $layout="admin";
    public $page_title = "Quản lý danh mục Đơn Hàng";
