        ...
        <ul class="nav navbar-nav">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li>
                        <a href="?app=ca_cong_van&view=ds_cv_den">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                     <li><a href="?app=ca_dia_ban">Danh mục địa bàn</a></li>   
                </ul>
            </li>
             <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"> 
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li>
                        <a href="?app=ht_vai_tro"><i class="glyphicon glyphicon-user"></i>  QL Vai trò</a>
                    </li>
                    <li>
                        <a href="?app=ht_tai_khoan"><i class="glyphicon glyphicon-user"></i>  Quản lý tài khoản</a>
                    </li>
                    <li>
...
<!--Hidden field-->
<input type="hidden" id="TAIKHOAN" value=" <?=$this->loaduser['TAI_KHOAN']?>" />