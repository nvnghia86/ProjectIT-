	...
	<form method="post" action="?controller=chdmbaohanh&action=luu">
		<table style="width:400px">
			<tr>
				<td>Tên</td>
				<td>
					<input type="text" size="30" name="Ten" placeholder="Tên" value="<?=$this->DmBaoHanh->Ten?>" />
				</td>
			</tr>
			<tr>
				<td>Mô tả</td>
				<td>
					<input type="text" size="30" name="MoTa" placeholder="Mô tả" value="<?=$this->DmBaoHanh->MoTa?>" />
				</td>
			</tr>
			<tr>
				<td>Trạng thái</td>
				<td>
					<input type="text" size="30" name="TrangThai" placeholder="Trạng thái" value="<?=$this->DmBaoHanh->TrangThai?>" />
				</td>
			</tr>
		</table>
...
<br/>
<fieldset style="width:400px">
	<legend>Tìm kiếm bảo hành</legend>
...
<table border=1 width="1000px" >
	...
	<tbody>
		<tr>
			...
			<td><a href="?controller=chdmbaohanh&view=sua&id=<?=$this->DanhSach[$i]['id_dm_baohanh']?>">Sửa</a></td>
			<td><a href="?controller=chdmbaohanh&action=xoa&id=<?=$this->DanhSach[$i]['id_dm_baohanh']?>">Xóa</a></td>
		</tr>
			<?php } ?>
	</tbody>
</table>
